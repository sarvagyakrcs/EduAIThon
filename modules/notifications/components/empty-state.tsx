      ...
      <div className="flex flex-col items-center justify-center text-center">
        ...
        >
          <Button className="relative px-5 py-2.5">
            ...
            <span className="absolute inset-x-0 -bottom-px mx-auto block h-px w-1/2 bg-gradient-to-r from-transparent via-slate-500 to-transparent opacity-0 blur-sm transition duration-500 group-hover/btn:opacity-100" />
          </Button>
        </motion.div>
      </div>
    </motion.div>
