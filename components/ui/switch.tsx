...
const colors = {
  ...
  slate: [
    '[--switch-bg-ring:var(--color-slate-600)]/90 [--switch-bg:var(--color-slate-500)] dark:[--switch-bg-ring:transparent]',
    '[--switch:white] [--switch-ring:var(--color-slate-600)]/90 [--switch-shadow:var(--color-slate-900)]/20',
  ],
  violet: [
